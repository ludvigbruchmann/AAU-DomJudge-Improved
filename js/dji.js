...
$.get( scoreboardUrl, function( data ) {
  ...
  $.get( teamsUrl, function( data ) {
    ...
    $('.table').html(
      ...
      "<tr><th>#</th><th>User</th><th>Score</th><th>Accuracy</th><th>DomJudge Points</th></tr>" +
      "</table>"
    );
    for (var i = 0; i < scoreboard.length; i++) {
      ...
      if(scoreboard[i]["score"]["num_solved"] > 0) {
        ...
        $('#users').append(
          ...
          "<td class=\"accuracy\">" + Math.round(advScore[1] * 100) + "%</td>" +
          "<td class=\"user\">" + scoreboard[i]["score"]["num_solved"] + "</td>" +
          "</tr>"
        );
      }
    }
